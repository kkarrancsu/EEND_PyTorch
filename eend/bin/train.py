...
parser.add_argument('--attractor-encoder-dropout', default=0.1, type=float)
parser.add_argument('--attractor-decoder-dropout', default=0.1, type=float)
parser.add_argument('--attractor-loss-ratio', default=1.0, type=float)
